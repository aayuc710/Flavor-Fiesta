...
if(isset($_POST['submit'])){
   ...
   $old_pass = filter_var($old_pass, 513); // 513 is the integer value for FILTER_SANITIZE_STRING
   $new_pass = sha1($_POST['new_pass']);
   $new_pass = filter_var($new_pass, 513); // 513 is the integer value for FILTER_SANITIZE_STRING
   $confirm_pass = sha1($_POST['confirm_pass']);
   $confirm_pass = filter_var($confirm_pass, 513); // 513 is the integer value for FILTER_SANITIZE_STRING
